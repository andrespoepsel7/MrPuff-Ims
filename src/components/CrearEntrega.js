...
export default function CrearEntrega() {
  ...
  return (
    <div>
        {/* Paso 1 */}
        <div className='bg-zinc-200 mt-6 mx-3 px-5 py-4 rounded-2xl border-2 border-zinc-500 shadow-lg shadow-gray-600'>
            ...
            <div className='flex justify-center mb-5'>
                ...
                >
                    {sucursales.map((sucursal)=>(
                        <option value={sucursal.email}>{sucursal.name}</option>
                    ))}
                </select>
            </div>
        </div>
